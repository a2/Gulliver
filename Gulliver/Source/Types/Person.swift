...
public struct PersonProperty {
    ...
    public static let Emails = MutableProperty<MultiValue<Email>>(propertyID: kABPersonEmailProperty, readTransform: readTransform, writeTransform: writeTransform)
    ...
    public static let Addresses = MutableProperty<MultiValue<PostalAddress>>(propertyID: kABPersonAddressProperty, readTransform: readTransform, writeTransform: writeTransform)
    public static let Dates = MutableProperty<MultiValue<Date>>(propertyID: kABPersonDateProperty, readTransform: readTransform, writeTransform: writeTransform)
    ...
    public static let Phones = MutableProperty<MultiValue<PhoneNumber>>(propertyID: kABPersonPhoneProperty, readTransform: readTransform, writeTransform: writeTransform)
    ...
    public static let URLs = MutableProperty<MultiValue<URL>>(propertyID: kABPersonURLProperty, readTransform: readTransform, writeTransform: writeTransform)
