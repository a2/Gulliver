...
public struct PersonProperty {
    ...
    public static let Emails = MutableProperty<MultiValue<MultiString>>(propertyID: kABPersonEmailProperty, readTransform: readTransform, writeTransform: writeTransform)
    ...
    public static let Dates = MutableProperty<MultiValue<MultiDate>>(propertyID: kABPersonDateProperty, readTransform: readTransform, writeTransform: writeTransform)
